...
| ICL (zero-shot, reasoning)                        | o4-mini                                                     | 80.95%  | 88.89%  | 83.33% | 72.22%  | 83.33%  | 81.66%     |
| ICL (zero-shot, reasoning) + RAG                  | o4-mini                                                     | 88.10%  | 94.44%  | 86.67% | 77.78%  | 75.00%  | 85.84%     |
| ICL (zero-shot, reasoning)                        | gemini-2.5-pro-exp-03-25                                    | 100.00% | 88.89%  | 90.00% | 100.00% | 100.00% | 95.83%     |
| ICL (zero-shot, reasoning) + RAG                  | gemini-2.5-pro-exp-03-25                                    | 100.00% | 94.44%  | 93.33% | 94.44%  | 100.00% | 96.44%     |
| ICL (zero-shot, reasoning)                        | gemini-2.0-flash-thinking-exp-01-21                         | 85.71%  | 94.44%  | 70.00% | 61.11%  | 91.67%  | 80.00%     |
| ICL (zero-shot, reasoning) + RAG                  | gemini-2.0-flash-thinking-exp-01-21                         | 97.62%  | 94.44%  | 93.33% | 100.00% | 100.00% | **96.67%** |
| ICL (zero-shot, reasoning) + Agentic RAG          | gemini-2.0-flash-thinking-exp-01-21                         | 92.86%  | 94.44%  | 90.00% | 100.00% | 100.00% | 94.17%     |
| ICL (zero-shot, reasoning)                        | gemini-2.5-flash-preview-04-17                              | 97.62%  | 94.44%  | 70.00% | 100.00% | 100.00% | 90.83%     |
| ICL (zero-shot, reasoning) + RAG                  | gemini-2.5-flash-preview-04-17                              | 97.62%  | 94.44%  | 93.33% | 100.00% | 100.00% | **96.67%** |
| ICL (zero-shot, reasoning)                        | DeepSeek R1                                                 | 92.86%  | 100.00% | 86.67% | 66.67%  | 83.33%  | 87.50%     |
| ICL (zero-shot, reasoning) + RAG                  | DeepSeek R1                                                 | 90.48%  | 88.88%  | 73.33% | 94.44%  | 100.00% | 87.50%     |
| ICL (zero-shot)                        | Mistral large                                               | 90.48%  | 88.89%  | 60.00% | 72.22%  | 83.33%  | 79.17%     |
| ICL (zero-shot, reasoning)                        | Claude 3.7 Sonnet (Thinking)                                | 92.86%  | 94.44%  | 93.33% | 100.00% | 100.00% | 95.00%     |
| ICL (zero-shot, reasoning) + RAG                  | Claude 3.7 Sonnet (Thinking)                                | 92.86%  | 94.44%  | 96.67% | 100.00% | 100.00% | 95.83%     |
| ICL (zero-shot, reasoning)                        | QwQ-32B                                                     | 76.19%  | 88.89%  | 86.67% | 72.22%  | 100.00% | 82.50%     |
| ICL (zero-shot, reasoning) + RAG                  | QwQ-32B                                                     | 88.10%  | 88.89%  | 83.33% | 94.44%  | 40.00%  | 83.17%     |
| ICL (zero-shot, reasoning)                        | Qwen3-32B                                                   | 80.95%  | 94.44%  | 76.67% | 89.89%  | 75.00%  | 82.50%     |
| ICL (zero-shot, reasoning)                        | Qwen3-30B-A3B                                               | 80.95%  | 83.33%  | 68.00% | 77.78%  | 75.00%  | 77.00%     |
| ICL (zero-shot)                        | Phi 4 14B                                                   | 64.29%  | 72.22%  | 46.67% | 43.33%  | 58.33%  | 57.33%     |
| ICL (zero-shot, reasoning)                        | DeepSeek R1 Distill Qwen 14B                                | 70.95%  | 55.56%  | 47.33% | 55.56%  | 75.00%  | 60.83%     |
| ICL (zero-shot, reasoning) + RAG                  | DeepSeek R1 Distill Qwen 14B                                | 76.19%  | 77.78%  | 60.67% | 66.67%  | 33.33%  | 66.83%     |
| ICL (zero-shot, reasoning) + Agentic RAG          | DeepSeek R1 Distill Qwen 14B                                | 50.00%  | 83.33%  | 43.33% | 44.44%  | 58.33%  | 53.33%     |
